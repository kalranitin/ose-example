 ...
 */
public class FrontEndAppServer {
    public static void main(String[] args) throws Exception {
    	
    	FrontEndAppServer appServer = new FrontEndAppServer();
    	appServer.start();
...
//        String webappDirLocation1 = "src/main/webapp/";
        ...
        String webappDirLocation = this.getClass().getClassLoader().getResource("src/main/webapp/").toExternalForm();
